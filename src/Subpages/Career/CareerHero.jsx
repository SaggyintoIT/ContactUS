          ...
          <div className="row align-items-center mt-md-0 mt-3">   
            <div className="col-md-6 tracking-in-expand">   
              <span className="text-white fn-30 fw-200 pe-md-5">
                <span className="fw-600 d-md-block">Ready to do the best work of your life?</span> Then 
                it’s you we are after!
              </span> 
            ...
            <div className="col-md-6 text-end pb-5">
              <img className="imgph-w rounded30 my-4" src={careerHero} alt="Career" />
            </div>
          </div>
        </div>
      </section>
