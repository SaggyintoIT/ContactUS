        ...
        <div className="row align-items-md-center">
          <div className="col-md-12 text-center">
            ...
            <p className="font-18 poppins-regular my-3">
              We're hiring for the following positions. If you are interested in
              any and find yourself the best fit, please apply here.
            </p>
          </div>
        </div>
                    ...
                    {openIndex === index && (
                      ...
                      >
                        <div className="accordion-body text-dark">
                          ...
                          <p className="fw-bold mb-2 mt-3">What you’ll need</p>
                          <ul className="list-unstyled requirements">
