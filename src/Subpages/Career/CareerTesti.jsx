          ...
          <div className="pt-3 px-md-0 px-4">
            <div className="testimonial">
              <div className="testimonial__inner">
                <Slider ref={sliderRef} {...settings} className="testimonial-slider talentedcareer">
                  <div className="testimonial-slide">
                    <img src={talented} alt="talented" className="w-100 myCareerTestimage"/>
                  </div>
                  <div className="testimonial-slide">
                    <img src={talented2} alt="talented" className="w-100 myCareerTestimage" />
                  </div>
                  <div className="testimonial-slide">
                    <img src={talented3} alt="talented" className="w-100 myCareerTestimage" />
                  </div>
                </Slider>
                <div className="btn-wrap bodypx">
                  <button className="prev-btn com-btn mr-3" onClick={() => sliderRef.current.slickPrev()}>
                    <span>
                      <img src={left} alt="prev" />
                    </span>
                  </button>
                  <button className="next-btn com-btn" onClick={() => sliderRef.current.slickNext()}>
                    <span>
