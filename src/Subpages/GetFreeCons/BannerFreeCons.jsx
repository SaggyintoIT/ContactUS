...
<div className="text-center h-450 text-white pt-70">
    ...
    <p className="fn-24">Are You Ready to Level-up Your Business With a Reliable Technology Partner?</p>
</div>
</section>
                              ...
                              <div className="country-list collaborate-list">
                                <div className="SumoSelect" tabIndex="0">
                                  <select
                                    ...
                                    tabIndex="-1"
                                  >
                                    <option value="what you are looking for?*" selected>
                                  ...
                                  <div className="country-list collaborate-list">
                                    <div className="SumoSelect" tabIndex="0">
                                      <select
                                        ...
                                        tabIndex="-1"
                                      >
                                        <option value="Select Budget*" selected>
                                          Select Budget*
                                        </option>
