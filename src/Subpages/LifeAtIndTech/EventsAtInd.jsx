          ...
          <div className="bodypx">
            <div className="row">
              <div className="col-md-12 text-center">
                <h2>Events, Celebrations, Functions, Festivals and much more!</h2>
                <p className="px-md-5">
                  At INDTechMark, we believe in enjoying each and every moment of life. We are enjoying freedom of speech, expressions, emotions, thoughts and most importantly sharing fun. Therefore, our life at MI is full of hustle- bustle, collisions and recreation at all level of personal and professional aspects.
                </p>
              </div>
              <div className="eventsfestivals">
                <div className="dicelebrating">
                  <ul className="d-flex justify-content-between ps-0 align-items-center">
                    <li className="w-100 p-all"><img className="w-100 EventImg" src={Dicelebrating1} alt="Dicelebrating 1" /></li>
                    <li className="w-100 p-all"><img className="w-100 EventImg" src={Dicelebrating2} alt="Dicelebrating 2" /></li>
                    <li className="w-100 p-all"><img className="w-100 EventImg" src={Dicelebrating3} alt="Dicelebrating 3" /></li>
                    <li className="w-100 p-all"><img className="w-100 EventImg" src={Dicelebrating4} alt="Dicelebrating 4" /></li>
                  </ul>
                  <ul className="d-flex justify-content-between ps-0 lastch">
                    <li className="w-100 p-all">
                      <div className="d-flex align-items-center h-100">
                        <h2>Diwali Celebration <br /> 2024</h2>
                      </div>
                    </li>
                    <li className="w-100 p-all"><img className="w-100 EventImg" src={Dicelebrating6} alt="Dicelebrating 6" /></li>
                    <li className="w-100 p-all"><img className="w-100 EventImg" src={Dicelebrating7} alt="Dicelebrating 7" /></li>
                    <li className="w-100 p-all"><img className="w-100 EventImg" src={Dicelebrating8} alt="Dicelebrating 8" /></li>
                  </ul>
                </div>
                <div className="dicelebrating">
                  <ul className="d-flex justify-content-between ps-0 align-items-center">
