...
const Life = () => {
  ...
  return (
    <>
    <section className="bg-off-white overflow-hidden py-80" id="lifeandculture">
      <div className="bodypx pb-4">
        <div className="container-fluid">
          <div className="row align-items-md-center">
            <div className="col-md-7 text-center text-sm-start">
              <h2>Life @INDTechMark</h2>
              <p>We work, laugh, celebrate, share experiences, and grow stronger together!!!</p>
            </div>
            <div className="col-md-5 text-md-end text-center">
              <a href="portfolio" className="btn-darkblack mt-2 mt-xl-3 fw-bold fn-16">
                    ...
                    {images.map((image, index) => (
                        ...
                        <div className="img-div">
                          <div className="img-big">
                            <img width="750" height="500" src={image.big} loading="lazy" alt="celebration" className="img-fluid" />
                          </div>
                          <div className="img-small">
                            <div className="small-one">
                              <img width="750" height="500" src={image.smallOne} loading="lazy" alt="celebration" className="img-fluid" />
                            </div>
                            <div className="small-two">
                              <img width="750" height="500" src={image.smallTwo} loading="lazy" alt="celebration" className="img-fluid" />
                            </div>
                          </div>
                        </div>
                      </div>
       ...
       <div className="row">
         <div className="col-md-5 pe-md-0">
           <div className="redblackbg text-center text-md-start radius-left py-5 px-4 px-lg-5 h-100">
             <span className="fn-36 text-white pb-3 d-block">We Transform</span>
             <h2 className="text-white">Every Industry & Business Process.</h2>
           </div>
         </div>
